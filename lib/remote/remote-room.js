 ...
 * STATIC
 **/
RemotedRoom.register = function (conf)
{
    return new RemotedRoom(conf);
};
...
RemoteRoom.getOne = function (conf, client)
{
    ...
    {
        let room = rooms[conf.namespace] = new RemotedRoom(conf);
    ...
    rooms[conf.namespace][client.id] = new RemotedRoom(conf);
