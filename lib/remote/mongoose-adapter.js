...
adapter.prototype.saveAsync = function (paths)
{
    ...
    if (!this.__asyncSave)
    {
        this.__asyncSave = Promise.delay(0)
		.bind(this)
		.then(function ()
        {
    ...
    return this.__asyncSave;
};

adapter.prototype.__save = function ()
{
	this.__savePromise = this.model.saveAsync()
	.bind(this)
	.then(function()
	{
		this.__savePromise = null;
		return this;
	});
...
adapter.prototype.destroy = function (keepInDB)
{
    ...
    if (!keepInDB)
	{
		if (this.__asyncSave)
		{
			this.__asyncSave.cancel();
			delete this.__asyncSave;
		}
		Promise.resolve(this.__savePromise)
		.bind(this)
		.then(function()
		{
			this.model.remove();
